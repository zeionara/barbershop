...
#positions
('read_positions','rp', cms.get_read_delete_rules('rp', p.field_status, p.field_shorts, p.field_names, p.field_descriptions), p.read),
...
#salaries
('read_salaries','rs', cms.get_read_delete_rules('rs', s.field_status, s.field_shorts, s.field_names, s.field_descriptions), s.read),
('create_salary','cs', cms.get_create_rules('cs',  s.field_status, s.field_shorts, s.field_names, s.field_descriptions), s.create),
('update_salaries','us', cms.get_update_rules('us',  s.field_status, s.field_shorts, s.field_names, s.field_descriptions), s.update),
('delete_salaries','ds', cms.get_update_rules('ds',  s.field_status, s.field_shorts, s.field_names, s.field_descriptions), s.delete),
#premium_sizes
