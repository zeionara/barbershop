...
commands = sorted((('get_schedule','gs', 'master_id [date_of_visit_in_format_10.10.2010]', get_schedule.execute),
            ...
            ('update_position','up','state_id [-n new_name] [new_description]', positions.update),
            ...
            ('fake_contact','fc','contact_id [-i person_id] [-s person_status] [-t contact_type] [-c contact]', contacts.fake),
            ...
            ('create_holding','ch','holding_name price quantity', holdings.create),
            ('update_holding','uh','holding_id [-n holding_name] [-p price] [-q quantity]', holdings.update),
            ...
            ('update_salary','usl','salary_id [-i worker_id] [-c common] [-v vacation] [-s sick]', salaries.update),
